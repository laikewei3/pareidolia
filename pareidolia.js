...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'images/demo (11).png', 'path': 'images/demo (11).png'},
    {'name': 'images/demo (12).png', 'path': 'images/demo (12).png'},
    {'name': 'images/demo (13).png', 'path': 'images/demo (13).png'},
    {'name': 'images/demo (14).png', 'path': 'images/demo (14).png'},
...
function demoRepsLoopBegin(demoRepsLoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisDemoRep of demoReps) {
...
function demoloopRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of demoloopComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ExpIntructionRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ExpIntructionComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
